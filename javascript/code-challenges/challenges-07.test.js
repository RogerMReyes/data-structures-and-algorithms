...
const splitFoods = (recipe) => {
  ...
  for(let ingredient of recipe.ingredients){
    ...
    let newWord = newArr.slice(2).join((' '));
    result.push(newWord);
  }
  return result;
};
...
const removeLastCharacters = (str, numberOfCharacters) => {
  ...
  if(numberOfCharacters > newArr.length){
    return '';
  }
    ...
    newArr.splice(newArr.length-numberOfCharacters, newArr.length);
    return newArr.join('');
  }
};
...
const removeVowels = (str) => {
  if(str.includes('e')){
    let newArr = str.split('e');
    str = newArr.join('');
  }
  if(str.includes('o')){
    let newArr = str.split('o');
    str = newArr.join('');
  }
  if(str.includes('a')){
    let newArr = str.split('a');
    str = newArr.join('');
  }
  if(str.includes('i')){
    let newArr = str.split('i');
    str = newArr.join('');
  }
  if(str.includes('u')){
    let newArr = str.split('u');
    str = newArr.join('');
  }
  return str;
};
...
const extractVowels = (str) => {
  ...
  let vowels = [];
  for(let char of str){
    vowels.push(char[char.indexOf('a')]);
    vowels.push(char[char.indexOf('e')]);
    vowels.push(char[char.indexOf('i')]);
    vowels.push(char[char.indexOf('o')]);
    vowels.push(char[char.indexOf('u')]);
  }
  vowels.sort((a,b) => a < b ? -1 : 1);
  let newVowels = vowels.join('');
  let newStr = removeVowels(str);
  newArr.push(newStr);
  newArr.push(newVowels);
  return newArr;
};
