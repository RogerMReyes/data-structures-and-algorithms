...
const checkValues = (obj, value) => {
  let bool = false;
  Object.entries(obj).forEach(array => bool = array.includes(value));
  return bool;
};
...
const getHouses = (arr) => {
  ...
  for (let object of arr) {
    Object.keys(object).length === 4 ? houses.push(Object.values(object)[3]) : houses.push(Object.values(object)[2]);
  }
  return houses;
};
...
const hasChildrenValues = (arr, character) => {
  for (let object of arr) {
    if (Object.values(object).includes(character)) {
...
const hasChildrenEntries = (arr, character) => {
  for (let object of arr) {
    if (Object.entries(object)[0].includes(character)) {
      if (Object.entries(object).length === 4) {
        if (Object.entries(object)[2]) {
          return true;
        }
        return false;
      }
...
const totalCharacters = (arr) => {
  ...
  for (let object of arr) {
    for (let array of Object.entries(object)) {
      array.includes('name') ? counter = counter + 1
        : array.includes('spouse') && !array.includes(null) ? counter = counter + 1
          : array.includes('children') ? array[1].forEach(child => counter++)
            : counter;
    }
  }
  return counter;
...
const houseSize = (arr) => {
  ...
  for (let object of arr) {
    ...
    sizes.push({ house: object.house, members: counter });
  }
  return sizes;
};
...
const houseSurvivors = (arr) => {
  const survivors = [];
  for (let object of arr) {
    for (let deceased of deceasedSpouses) {
      object.spouse !== null ? object.spouse.includes(deceased) ? object.spouse = null : object.spouse : object.spouse;
    }
  }
  ...
  for (let object of arr) {
    ...
    survivors.push({ house: object.house, members: counter });
  }
  return survivors;
};
